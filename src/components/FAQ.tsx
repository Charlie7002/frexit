...
const FAQ: React.FC = () => {
    return (
        <section id="apropos" className="py-10 lg:py-20">
            <div className="flex flex-col lg:flex-row gap-10">
                <div className="">
                    ...
                    <p className="lg:mt-10 text-foreground-accent text-center lg:text-left">
                        Parlons de vos besoins IT, sécurité ou support.
                    </p>
                    <a href="mailto:contact@frexit.fr" className="mt-3 block text-xl lg:text-4xl text-secondary font-semibold hover:underline text-center lg:text-left">contact@frexit.fr</a>
                </div>
