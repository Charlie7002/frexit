		...
		>
			...
			<div className="text-center">
				...
				<div className="mt-6 flex flex-col sm:flex-row items-center sm:gap-4 w-fit mx-auto">
					<Link
						href="#contact"
						className="bg-blue-300 text-black px-8 py-3 rounded-full font-semibold hover:bg-blue-200 transition-colors"
					>
						Contactez-nous
					</Link>
					<Link
						href="#services"
						className="px-8 py-3 rounded-full font-semibold border border-foreground/20 hover:border-foreground transition-colors"
					>
